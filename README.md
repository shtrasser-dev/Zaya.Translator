...
Requires [Zaya.Primitives](https://github.com/shtrasser-dev/Zaya.Primitives) **2.0.0**. Plugin engines also use [Zaya.Logging](https://github.com/shtrasser-dev/Zaya.Logging) **1.0.0**.

Update channels (GitHub Releases):

- Translator engines: [`plugin-Zaya.Translator-v2.0-latest`](https://github.com/shtrasser-dev/Zaya.Translator/releases/tag/plugin-Zaya.Translator-v2.0-latest)
- Cache engine: [`plugin-Zaya.TranslatorCache-v2.0-latest`](https://github.com/shtrasser-dev/Zaya.Translator/releases/tag/plugin-Zaya.TranslatorCache-v2.0-latest)
