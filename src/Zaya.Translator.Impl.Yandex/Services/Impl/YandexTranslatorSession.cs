...
using Zaya.Translator.Impl.Yandex.Exceptions;
using Zaya.Translator.Services;

namespace Zaya.Translator.Impl.Yandex.Services.Impl;
...
/// </summary>
internal sealed class YandexTranslatorSession : ITranslatorSession
{
